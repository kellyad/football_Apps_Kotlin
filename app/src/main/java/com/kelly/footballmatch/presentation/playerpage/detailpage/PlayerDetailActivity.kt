package com.kelly.footballmatch.presentation.playerpage.detailpage
...
import com.kelly.footballmatch.external.adapter.pageradapter.ImageProfileAdapter
...
class PlayerDetailActivity: AppCompatActivity() {
    ...
    private fun setupImageAdapter(player: Player){
