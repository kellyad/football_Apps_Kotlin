package com.kelly.footballmatch.external.adapter
...
class TeamViewHolder(view: View) : RecyclerView.ViewHolder(view){
    ...
    fun bindItem(teams: Team, listener: (Team) -> Unit) {
        if(teams.strTeamBadge !== null  && teams.strTeamBadge !== "") {
            Picasso.get().load(teams.strTeamBadge).into(teamImage)
        }
        ...
        if(teams.strTeamJersey !== null && teams.strTeamJersey !== "" ) {
             Picasso.get().load(teams.strTeamJersey).into(teamJersey)
        }
